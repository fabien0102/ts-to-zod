...
describe("validateGeneratedTypes", () => {
  ...
  it("should return no error if we use a deep external import", () => {
    ...
    export const citizenSchema = z.object({
      villain: villainSchema.optional()
      heroData: z.object({
        name: z.string(),
        hero: heroSchema.optional()
      })
  ...
  it("should return no error if we use a deep external import with union", () => {
    ...
    export const citizenSchema = z.object({
      ...
      heroData: z.object({
        name: z.string(),
        hero: z.union([heroSchema, z.string()]).optional()
      })
    });
    `,
      relativePath: "source.zod.ts",
  ...
  it("should return no error if we use a deep external import with union", () => {
    ...
    export const citizenSchema = z.object({
      ...
      heroData: z.object({
        name: z.string(),
        hero: z.union([z.object({id: heroSchema.optional()}), z.string()]).optional()
      })
    });
    `,
      relativePath: "source.zod.ts",
  ...
  it("should return no error if we use a non-optional undefined in union type", () => {
    ...
    import { z } from "zod";
    export const citizenSchema = z.object({
      villain: z.union([z.string(), z.undefined()]).optional()
    });
    `,
      relativePath: "source.zod.ts",
    };
